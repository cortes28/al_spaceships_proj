...
class Ship(Sprite):
    ship_images = [pg.transform.rotozoom(pg.image.load(f'images/ship.png'), 0, 1)]
    ship_explosion_images = [pg.transform.rotozoom(pg.image.load(f'images/ship_explode{n}.png'), 0, 1.0) for n in range(7)]
