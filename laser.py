...
class Laser(Sprite):
    ...
    alien_laser_images = [pg.transform.rotozoom(pg.image.load(f'images/al_las{n}.png'), 0, 2) for n in range(2)]
    ship_laser_images = [pg.transform.rotozoom(pg.image.load(f'images/las{n}.png'), 0, 2) for n in range(4)]
    ...
    def draw(self):
        ...
        rect = image.get_rect()
        rect.centerx, rect.top = self.rect.centerx, self.rect.top
