...
class Alien(Sprite):
    ...
    alien_images0 = [pg.transform.rotozoom(pg.image.load(f'images/alien__0{n}.png'), 0, 1.7) for n in range(2)]
    alien_images1 = [pg.transform.rotozoom(pg.image.load(f'images/alien__1{n}.png'), 0, 1.7) for n in range(2)]
    alien_images2 = [pg.transform.rotozoom(pg.image.load(f'images/alien__2{n}.png'), 0, 1.7) for n in range(2)]
    ...
    alien_explosion_images = [pg.transform.rotozoom(pg.image.load(f'images/explosion0{n}.png'), 0, 1.2) for n in range(10)]
